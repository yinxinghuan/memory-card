...
- 平台元信息：meta.title=Memory Card；category=puzzle；uuid=af3a5ec2-3753-4031-b8f9-d5d945a2cf19
...
- `src/MemoryCard/MemoryCard.less`
- `src/MemoryCard/MemoryCard.tsx`
- `src/MemoryCard/types.ts`
- `src/MemoryCard/index.ts`
- `src/MemoryCard/utils/sounds.ts`
- `src/MemoryCard/components/GameBoard.tsx`
