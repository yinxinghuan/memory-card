...
const MESSAGES: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'char.guitarist_side.name': 'Algram 飞翔版',
    'char.coder.name': '咖啡女孩 · Jenny',
    'char.coder_side.name': 'Jenny 飞翔版',
    'char.hacker.name': '眼镜大叔 · JM·F',
    'char.hacker_side.name': 'JM·F 飞翔版',
    'char.ghost.name': '调皮幽灵 · ghostpixel',
    'char.ghost_side.name': 'ghostpixel 飞翔版',
  },
  en: {
    title: 'MEMORY',
    ...
    'char.guitarist_side.name': 'Algram Flying',
    'char.coder.name': 'Coffee Girl · Jenny',
    'char.coder_side.name': 'Jenny Flying',
    'char.hacker.name': 'Hacker Dude · JM·F',
    'char.hacker_side.name': 'JM·F Flying',
    'char.ghost.name': 'Cheeky Ghost · ghostpixel',
    'char.ghost_side.name': 'ghostpixel Flying',
  },
};
